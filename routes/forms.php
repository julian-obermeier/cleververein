...
Route::middleware(['installed', 'auth', 'verified', 'tenant'])->group(function (): void {
    ...
    Route::put('/formulare/{form}', [FormController::class, 'update'])->middleware('form-editable')->name('forms.update');
    Route::post('/formulare/{form}/veroeffentlichen', [FormController::class, 'publish'])->middleware(['form-editable', 'form-publishable'])->name('forms.publish');
    Route::patch('/formulare/{form}/archivieren', [FormController::class, 'archive'])->name('forms.archive');

    Route::middleware('form-editable')->group(function (): void {
