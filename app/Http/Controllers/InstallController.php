...
class InstallController extends Controller
{
    ...
    public function store(Request $request, string $step, EnvironmentWriter $environment): RedirectResponse
    {
        ...
        file_put_contents(storage_path('app/installed'), json_encode(['version' => '0.11.0', 'installed_at' => now()->toIso8601String()], JSON_PRETTY_PRINT | JSON_THROW_ON_ERROR), LOCK_EX);
