...
<aside id="app-sidebar" data-sidebar class="fixed inset-y-0 left-0 z-50 flex w-64 -translate-x-full flex-col bg-brand-950 text-slate-100 transition-transform lg:translate-x-0" aria-label="Hauptnavigation">
    ...
    @php($items = [
        ...
        ['Bankabgleich','finance.bank.index','finance.bank.*','M3 6h18v12H3V6Zm2 2v2h14V8H5Zm0 4v4h14v-4H5Zm2 1h4v2H7v-2Z'],
    ...
    <div class="border-t border-white/10 p-3 text-sm text-slate-400">Hilfe & Support<br><span class="text-xs">Version 0.11.0 · Veranstaltungen & Kommunikation</span></div>
</aside>
